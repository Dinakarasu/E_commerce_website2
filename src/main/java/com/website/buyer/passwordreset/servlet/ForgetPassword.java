...
public class ForgetPassword extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String password = "oxfi xmou juvu bcft"; // App Password

            // ✅ FIX 1: Use port 587 + STARTTLS (not 465 SSL which gets blocked)
            // ✅ FIX 2: Add connection & read timeouts to stop infinite loading
            Properties props = new Properties();
            props.put("mail.smtp.host", "smtp.gmail.com");
            props.put("mail.smtp.port", "587");
            props.put("mail.smtp.auth", "true");
            props.put("mail.smtp.starttls.enable", "true");
            props.put("mail.smtp.connectiontimeout", "10000"); // 10 sec connect timeout
            props.put("mail.smtp.timeout", "10000");           // 10 sec read timeout
            props.put("mail.smtp.writetimeout", "10000");      // 10 sec write timeout
            ...
            // ✅ FIX 3: On ANY error, redirect back with a message — stops infinite loading
            e.printStackTrace();
            mySession.setAttribute("failedMsg", "Failed to send OTP. Please try again later.");
            response.sendRedirect("forgetpassword.jsp");
        }
    }
}